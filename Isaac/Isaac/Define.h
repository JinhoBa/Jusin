...
enum OBJID { OBJ_DEADEFFECT,OBJ_PLAYER, OBJ_MONSTER, OBJ_BULLET, OBJ_TILE, OBJ_ITEM, OBJ_DOOR, OBJ_EFFECT, OBJ_END };
enum UIID { UI_BAR, UI_BUTTON,UI_MOUSE, UI_BOSSHP, UI_MINIMAP, UI_END };
enum CHANNELID { SOUND_BGM, SOUND_EFFECT, SOUND_INTRO, SOUND_BOMBEFFECT, SOUND_TEAR, SOUND_TEARDEAD,SOUND_BOSSEND, SOUND_END = 32 };
